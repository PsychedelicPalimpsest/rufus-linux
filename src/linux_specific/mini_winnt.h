/*
 * Win32 definitions for Windows NT. Taken from wine
 *
...
#include <stdint.h>
#define DWORD64 unsigned uint64_t;
#define ULONG64 unsigned uint64_t;
...
typedef unsigned char   BYTE,       BOOL,     *PBYTE,    *LPBYTE;
